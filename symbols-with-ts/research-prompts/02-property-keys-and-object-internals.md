# Deep Research Prompt: Property Keys And Object Internals

**Target tool**: Gemini Deep Research (or comparable)
**Intended use**: Audio-friendly content for NotebookLM
**Lesson**: openspec/changes/02-property-keys-and-object-internals/

## Prompt

Research why this lesson's symbol concepts exist and what design pressure they answer. Anchor the discussion to these concepts only: ECMAScript PropertyKey model; string keys vs symbol keys; object property records; key coercion boundaries. Focus on historical motivation, mental models, adjacent concepts, and the tradeoffs that made this part of JavaScript's object and protocol model necessary. Avoid syntax walkthroughs and avoid expanding into a full survey of JavaScript Symbols.
