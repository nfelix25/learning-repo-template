...
// Carries forward lessons 23-26, adds UnionSchema<Schemas>, IntersectionSchema<A, B>,
// and factory functions union() and intersection().
...
// Extract the union of output types from a tuple of schemas
